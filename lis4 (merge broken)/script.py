...
def extract_data_from_fincare(data):
    ...
    for line in cleaned_lines:
        ...
        if line.startswith("OBX|"):
            ...
            zipped_tests = dict(zip(cleaned_test_names, cleaned_test_values))
            
            # print("zipped_tests", zipped_tests)

            if patient_id in patients_dict:
                patients_dict[patient_id].update(zipped_tests)
            else:
                patients_dict[patient_id] = zipped_tests
