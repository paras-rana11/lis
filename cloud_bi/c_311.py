        ...
        while True:
            try:
                ...
                if flag:
                    ...
                    add_case_to_json(case_entry, machine_id, 'complete_case_C_311.json')
                ...
                add_case_to_json(case_entry, machine_id, 'error_case_C_311.json')
            counter+=1
            time.sleep(5)
    except Exception as e:
...
if __name__ == "__main__":
    try:
        JSON_FILE_LIST = [
            os.path.join(CASE_FILE_PATH, 'complete_case_C_311.json'),
            os.path.join(CASE_FILE_PATH, 'error_case_C_311.json'),
        ]
