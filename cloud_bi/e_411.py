...
MACHINE_NAME = 'Cobas C 411 1'
HOST_ADDRESS = '127.0.0.1'
HOST_PORT = 6020
HOST_COM_PORT = 'COM2'
MACHINE_ID = 'E_411_1'
REPORT_FILE_PREFIX = 'E_411_1_'
CONNECTION_TYPE = 'serial'

LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_E_411_1.log'
ERROR_LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_E_411_1_error.log'
...
def retry_api_call( case_id, test_id, sample_type, machine_id, connection='pas'):
        ...
        while True:
            try:
                ...
                if flag:
                    ...
                    add_case_to_json(case_entry, machine_id, 'complete_case_E_411.json')
                ...
                add_case_to_json(case_entry, machine_id, 'error_case_E_411.json')
            counter+=1
            time.sleep(5)
    except Exception as e:
...
if __name__ == "__main__":
    try:
        JSON_FILE_LIST = [
            os.path.join(CASE_FILE_PATH, 'complete_case_E_411.json'),
            os.path.join(CASE_FILE_PATH, 'error_case_E_411.json'),
        ]
