...
CONNECTION_BS_240 = True

CONNECTION_TYPE = "TCP/IP"
HOST_ADDRESS = "192.168.1.160"
HOST_PORT = 6050
HOST_CONNECTION_PORT = 5050
REPORT_FILE_PREFIX = 'BS_240'
MACHINE_ID = 'BS_240'

# log file path
CASE_FILE = 'C:\\ASTM\\root\\case_file\\complete_case_BS_240.json'

LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_BS_240_info.log'
ERROR_LOG_FILE = 'C:\\ASTM\\root\\log_file\\logging_for_BS_240_error.log'
...
try:
    pass
    # CONNECTION_BS_240 = MachineConnectionTcp(
    #     server_ip=HOST_ADDRESS,
    #     server_port=HOST_CONNECTION_PORT, 
    #     machine_name=REPORT_FILE_PREFIX
    # )
    
    # port_BS_240 = CONNECTION_BS_240.get_connection()
    # logger.info(f"Connection established on port: {port_BS_240}")
except Exception as e:
...
def check_connection():
    try:
        while True:
            if not CONNECTION_BS_240.is_connected:
                port_BS_240 = CONNECTION_BS_240.get_connection()
            time.sleep(3600)
...
if __name__ == "__main__":
    try:
        ...
        JSON_FILE_LIST = [
            os.path.join(CASE_FILE_PATH, 'complete_case_BS_240.json'),
            os.path.join(CASE_FILE_PATH, 'error_case_BS_240.json'),
        ]
